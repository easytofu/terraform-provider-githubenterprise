---
title: githubenterprise_enterprise_team
page_title: "Resource: githubenterprise_enterprise_team"
description: "Manages a GitHub enterprise team. Requires a GitHub token configured on the provider."
slug: provider_resource_githubenterprise_enterprise_team
category:
...
position: 5
---
## Resource: githubenterprise_enterprise_team
...
```shell
terraform import githubenterprise_enterprise_team.example <enterprise>/<team_slug>
```
